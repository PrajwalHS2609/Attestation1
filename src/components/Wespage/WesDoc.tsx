  ...
  return (
    <div className="head-container">
      ...
      <ul>
        ...
        <li>
          <MdKeyboardDoubleArrowRight className="headList-icon" /> All
        ...
        <li>
          <MdKeyboardDoubleArrowRight className="headList-icon" /> WES
          form
        </li>
        <li>
          <MdKeyboardDoubleArrowRight className="headList-icon" /> WES
        ...
        <li>
          <MdKeyboardDoubleArrowRight className="headList-icon" /> 2
