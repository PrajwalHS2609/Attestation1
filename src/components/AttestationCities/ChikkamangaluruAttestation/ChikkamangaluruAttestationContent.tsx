  ...
  return (
    <div className="head-container">
      <p>
        ...
        <a href="">educational certificates</a>, birth and marriage
        certificates,{" "}
        <a href="https://foreignembassyattestation.com/commercial-documents-attestation-in-bangalore">
          commercial documents
        </a>
        , and legal affidavits. Whether your destination is a Hague Convention
        country requiring apostille, or a non-Hague country where full embassy
        attestation is necessary, these services ensure your documents are
        legally recognized abroad.
      </p>
      <p>
        The process of document attestation involves multiple steps, including
        verification from local government bodies, the Ministry of External
        Affairs, and in some cases, the embassy of the destination country.
      ...
      <p>
        ...
        checklist, ensure forms are filled correctly, and take care of
        submission, follow-up, and collection. This reduces the risk of document
      ...
      <p>
        Parents applying for dependent visas for their children or spouses going
        ...
        accepted without issues abroad makes these services indispensable.
      </p>
      <p>
        ...
        increasing cases of fake certificates and document fraud, it’s important
        to trust only reputed professionals who have a proven track record.
      </p>
      <p>
