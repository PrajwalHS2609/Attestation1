...
import MarriageCertificateAttestationFaq from './../../components/MarriageCertificateAttestation/MarriageCertificateAttestationFaq';
...
export default function MarriageCertificateAttestation() {
  return (
    <>
      <Script
        id="marriage-certificate-attestation-in-bangalore"
      ...
      <div className="main-container">
        ...
        <HomeCountries />
        <HomeWhy />
        <MarriageCertificateAttestationFaq />
