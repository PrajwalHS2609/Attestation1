...
export const metadata = {
  ...
  description: "Kerala State HRD Attestation in Bangalore is a crucial process for individuals who need to authenticate their educational documents for international purposes. ",
  canonical: "https://foreignembassyattestation.com/kerala-state-hrd-attestation-in-bangalore",
  keywords: [
