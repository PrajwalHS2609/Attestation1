...
export const metadata = {
    title: "Andhra Pradesh State HRD Attestation in Bangalore | HRD Attestation Near Me",
    description: "Andhra Pradesh State HRD Attestation in Bangalore is a crucial process for individuals who need to authenticate their educational documents for international purposes. ",
    canonical: "https://foreignembassyattestation.com/andhra-pradesh-state-hrd-attestation-in-bangalore",
    keywords: [
